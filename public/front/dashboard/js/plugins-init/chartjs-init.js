 ...
 var dzSparkLine = function(){
					...
					datasets: [
						{
							...
							borderColor: 'rgba(110, 197 , 30, 1)',
							borderWidth: "0",
							backgroundColor: 'rgba(110, 197 , 30, 1)'
						}
					]
				},
				options: {
	...
	var barChart2 = function(){
		...
		//gradient bar chart
			...
			barChart_2gradientStroke.addColorStop(0, "rgba(110, 197 , 30, 1)");
			barChart_2gradientStroke.addColorStop(1, "rgba(110, 197 , 30, 0.5)");
	...
	var barChart3 = function(){
		...
		if(jQuery('#barChart_3').length > 0 ){
			...
			barChart_3gradientStroke.addColorStop(0, "rgba(110, 197 , 30, 1)");
			barChart_3gradientStroke.addColorStop(1, "rgba(110, 197 , 30, 0.5)");

			const barChart_3gradientStroke2 = barChart_3.createLinearGradient(50, 100, 50, 50);
			barChart_3gradientStroke2.addColorStop(0, "rgba(55, 209, 191, 1)");
			barChart_3gradientStroke2.addColorStop(1, "rgba(55, 209, 191, 1)");

			const barChart_3gradientStroke3 = barChart_3.createLinearGradient(50, 100, 50, 50);
			barChart_3gradientStroke3.addColorStop(0, "rgba(192, 70, 211, 1)");
			barChart_3gradientStroke3.addColorStop(1, "rgba(192, 70, 211, 1)");
					...
					datasets: [
						{
							...
							pointBackgroundColor: 'rgba(110, 197 , 30, 1)'
						}
					]
				},
				options: {
	...
	var lineChart2 = function(){
		...
		if(jQuery('#lineChart_2').length > 0 ){
			...
			lineChart_2gradientStroke.addColorStop(0, "rgba(110, 197 , 30, 1)");
			lineChart_2gradientStroke.addColorStop(1, "rgba(110, 197 , 30, 0.5)");
					...
					datasets: [
						{
							...
							borderWidth: "2",
							backgroundColor: 'transparent', 
							pointBackgroundColor: 'rgba(110, 197 , 30, 0.5)'
						}
					]
				},
				options: {
	...
	var lineChart3 = function(){
		...
		if(jQuery('#lineChart_3').length > 0 ){
			...
			lineChart_3gradientStroke1.addColorStop(0, "rgba(110, 197 , 30, 1)");
			lineChart_3gradientStroke1.addColorStop(1, "rgba(110, 197 , 30, 0.5)");

			const lineChart_3gradientStroke2 = lineChart_3.createLinearGradient(500, 0, 100, 0);
			lineChart_3gradientStroke2.addColorStop(0, "rgba(255, 148, 50, 1)");
			lineChart_3gradientStroke2.addColorStop(1, "rgba(255, 148, 50, 1)");
					...
					datasets: [
						{
							...
							borderWidth: "1",
							backgroundColor: 'rgba(110, 197 , 30, .5)', 
	...
	var areaChart2 = function(){	
		...
		if(jQuery('#areaChart_2').length > 0 ){
			...
			areaChart_2gradientStroke.addColorStop(0, "rgba(192, 70, 211, 0.2)");
			areaChart_2gradientStroke.addColorStop(1, "rgba(192, 70, 211, 0)");
				...
				data: {
					...
					datasets: [
						...
						}, 
						{
							...
							borderColor: 'rgb(255, 148, 50)',
							borderWidth: "1",
							backgroundColor: 'rgba(255, 148, 50, .5)'
						}
					]
				},
				options: {
