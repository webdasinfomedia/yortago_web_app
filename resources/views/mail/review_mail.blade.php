...
<center class="wrapper">
    <table class="top-panel center" width="602" border="0" cellspacing="0" cellpadding="0">
        <tbody>
        <tr>
            <td class="title" width="300">Yortago</td>
            <td class="subject" width="300"><a class="strong" href="#" target="_blank">{{ env('MAIL_FROM_ADDRESS') }}</a></td>
        </tr>
        <tr>
                ...
                <table class="content" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                            Click the below link to give review on meeting
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                            <a href="{{ route('stream.rating',['stream_id'=>$stream_id]) }}" target="_blank">Give Review</a>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 15px 24px 15px; color: #8492a6;">
                            Yortago <br> Support Team
                        </td>
                    </tr>
