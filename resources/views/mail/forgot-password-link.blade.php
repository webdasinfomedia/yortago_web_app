    ...
    <tr>
        <td class="container">
            ...
            <table>
                ...
                <tr>
                    <td class="content">
                        <h2>Dear {{$user->name ?? null}},</h2>
                        <table>
                        <tr>
                            
                            <p>
                                <a href="{{ route('reset.password.form', $user->token) }}" target="_blank">Click here to Set Your Password</a>
                            </p>
                            <br>


                            <p>
                                We look forward to working with you and seeing the contributions you will make.
                            </p>
