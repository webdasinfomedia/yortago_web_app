...
<title>Yortago - Form Check Reply</title>
</head>
...
<h1 style="color:#1a1a1a;font-size:24px;margin:0 0 20px 0;font-weight:700;">Your Form Check Has a Reply</h1>
<p style="margin:15px 0;font-size:15px;line-height:1.6;">Hello <strong>{{ $user->name }}</strong>,</p>
<p style="margin:15px 0;font-size:15px;line-height:1.6;">Great news! Your uploaded form check video has received feedback from our coaching team.</p>

<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:25px 0;">
<tr>
<td style="background-color:#f8f9fa;border-left:4px solid #d76e33;padding:20px;">
<strong style="color:#1a1a1a;display:block;margin-bottom:8px;font-size:14px;text-transform:uppercase;letter-spacing:0.5px;">COACH'S FEEDBACK:</strong>
<p style="color:#555555;font-size:15px;line-height:1.6;margin:0;">{{ $reply }}</p>
</td>
</tr>
</table>

<center>
<a href="{{ $videoUrl }}" style="display:inline-block;background:#d76e33;color:#ffffff;text-decoration:none;padding:14px 32px;border-radius:6px;font-weight:600;font-size:15px;margin:20px 0;" target="_blank">View Your Video</a>
</center>

<p style="margin:15px 0;font-size:15px;line-height:1.6;">Review the feedback carefully and don't hesitate to reach out if you have any questions about implementing these suggestions into your training.</p>

<p style="margin:30px 0 0 0;font-size:15px;line-height:1.6;">
<strong>Keep pushing your limits!</strong><br>
...
<p style="margin:15px 0 0 0;font-size:12px;color:#666666;">© {{ date('Y') }} Yortago. All rights reserved.<br>This email was sent to {{ $user->email }}</p>
</td>
</tr>
</table>
</center>
