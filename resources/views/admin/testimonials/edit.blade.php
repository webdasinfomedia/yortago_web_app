                            ...
                            <div class="col-md-8">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="{{ $list['author_name'] }}" name="author_name" placeholder="Author Name">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" value="{{ $list['author_designation'] }}" name="author_designation" placeholder="Author Designation">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" name="description" rows="4" placeholder="Testimonial Description ...">{{ $list['description'] }}</textarea>
