            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @endif
                        <a href="{{route('admin.new.exercise.create_category')}}"
                            ...
                            <table id="example3" class="display min-w850">
                                ...
                                @foreach($categories as $key => $category)
                                    <tr>
                                        ...
                                        <td>{{$category->name}}</td>
                                        <td>
                                            <a href="{{route('admin.new.exercise.edit_category', ['id' => $category->id])}}"
                                               class="btn btn-rounded btn-primary btn-sm">
                                                Edit
                                            </a>
                                            <a href="{{route('admin.new.exercise.delete_category', ['id' => $category->id])}}"
