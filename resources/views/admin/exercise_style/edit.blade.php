            ...
            <div class="col-lg-4 col-md-4">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('admin.new.exercise.exercise_style')}}"
                           class="btn btn-rounded btn-secondary btn-sm" style="float: right">
                            Back</a>
                    </div>
                    <div class="card-body">
                        <div>
                            <form method="post" action="{{route('admin.new.exercise.update_exercise_style')}}">
                                @csrf
                                <div class="form-group">
                                    <input type="hidden" name="id" value="{{$exercise_style->id}}">
                                    <label>Name</label>
                                    <input class="form-control" value="{{$exercise_style->name}}" placeholder="Name" name="name" required>
                                    @error('name')
