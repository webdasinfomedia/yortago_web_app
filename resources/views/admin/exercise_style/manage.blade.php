            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        @endif
                        <a href="{{route('admin.new.exercise.create_exercise_style')}}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="example3" class="display min-w850">
                                ...
                                <tbody>
                                @foreach($exercise_styles as $key => $category)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td>{{$category->name}}</td>
                                        <td>
                                            <a href="{{route('admin.new.exercise.edit_exercise_style', ['id' => $category->id])}}"
                                               class="btn btn-rounded btn-primary btn-sm">
                                                Edit
                                            </a>
                                            <a href="{{route('admin.new.exercise.delete_exercise_style', ['id' => $category->id])}}"
