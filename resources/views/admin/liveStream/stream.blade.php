                        ...
                        <div class="card-header d-sm-flex d-block pb-0 border-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="mr-auto pr-3">
                                    <h4 class="text-black fs-20">Start Streaming</h4>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pb-0 mb-4">
                         ...
                         <div class="col-md-12">
                                ...
                                <button  onclick="startMeeting()" class="flex-c-m btn-primary rounded size3 s2-txt3 trans-04 where1" id="start-streaming" v-if="startStreaming"  style="text-align: center;position: absolute; top: 30px; bottom: 0; left: 0; right: 0; margin: auto; z-index: 2; max-width: 400px; height: 50px;">
                                  Start Meeting
                                </button>
                                <button  onclick="startMeeting()" class="flex-c-m btn-primary rounded size3 s2-txt3 trans-04 where1" id="start-streaming2" v-if="startStreaming2"  style="text-align: center;position: absolute; top: 30px; bottom: 0; left: 0; right: 0; margin: auto; z-index: 2; max-width: 400px; height: 50px; display: none">
                                   <span class="btn-icon-left text-info"><i class="fa fa-spinner fa-spin color-info"></i></span> Starting Meeting ....
                                </button>
                                <button  onclick="endMeeting()" class="flex-c-m btn-primary rounded size3 s2-txt3 trans-04 where1" id="end-streaming" v-if="startStreaming"  style="text-align: center;position: absolute; top: 30px; bottom: 0; left: 0; right: 0; margin: auto; z-index: 2; max-width: 400px; height: 50px; display: none;background: red;">
                                    End Meeting
                                </button>
                                @else
                                  <button  onclick="startMeeting()" class="flex-c-m btn-primary rounded size3 s2-txt3 trans-04 where1" id="start-streaming" v-if="startStreaming"  style="text-align: center;position: absolute; top: 30px; bottom: 0; left: 0; right: 0; margin: auto; z-index: 2; max-width: 400px; height: 50px;display: none; ">
                                    Start Meeting
                                </button>
                                <button  onclick="endMeeting()" class="flex-c-m btn-primary rounded size3 s2-txt3 trans-04 where1" id="end-streaming" v-if="startStreaming"  style="text-align: center;position: absolute; top: 30px; bottom: 0; left: 0; right: 0; margin: auto; z-index: 2; max-width: 400px; height: 50px;background: red; ">
                                    End Meeting
                                </button>
...
<script>
    ...
    Date.prototype.addHours = function(h){
        ...
        function makeTimer() {
            ...
            $.ajax({
			method: "POST",
			url: '{{ route('admin.live.streaming.time.left') }}',
            data: {
...
<script>
    function startMeeting(){
        ...
        $('#start-streaming2').show()
         $.ajax({
        type: "POST",
        url: `{{ route('admin.live.streaming.start') }}`,
        headers: {
    ...
    function endMeeting(){
         ...
         $.ajax({
        type: "POST",
        url: `{{ route('admin.live.streaming.end') }}`,
        headers: {
                   'X-CSRF-TOKEN': document.getElementById('csrf').getAttribute('content')
               },
        ...
        success: function(data)
        {
            $('#start-streaming').text('Start Meeting');
