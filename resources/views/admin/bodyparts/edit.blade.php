            ...
            <div class="col-lg-4 col-md-4">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('admin.new.exercise.bodyparts')}}"
                           class="btn btn-rounded btn-secondary btn-sm" style="float: right">
                            Back</a>
                    </div>
                    <div class="card-body">
                        <div>
                            <form method="post" action="{{route('admin.new.exercise.update_bodypart')}}">
                                @csrf
                                <div class="form-group">
                                    <input type="hidden" name="id" value="{{$bodypart->id}}">
                                    <label>Name</label>
                                    <input class="form-control" value="{{$bodypart->name}}" placeholder="Name" name="name" required>
                                    @error('name')
