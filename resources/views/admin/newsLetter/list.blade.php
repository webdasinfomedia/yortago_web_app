            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" class="btn btn-rounded btn-primary" onclick="window.location.href='{{ route('admin.newsletter.export') }}'" style="float: right">Export NewsLetter</button>
