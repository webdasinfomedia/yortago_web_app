            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{route('admin.new.exercise.create_exercise_list')}}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="example3" class="display min-w850">
                                ...
                                <tbody>
                                @foreach($exercise_lists as $key => $category)
                                    <tr>
                                        <td>{{$key+1}}</td>
                                        <td>{{$category->name}}</td>
                                        <td>{{$category?->body_part?->name}}</td>
                                        <td>{{$category?->exercise_style?->name}}</td>
                                        <td>
                                            <a href="{{route('admin.new.exercise.edit_exercise_list', ['id' => $category->id])}}"
                                               class="btn btn-rounded btn-primary btn-sm">
                                                Edit
                                            </a>
                                            <a href="{{route('admin.new.exercise.delete_exercise_list', ['id' => $category->id])}}"
