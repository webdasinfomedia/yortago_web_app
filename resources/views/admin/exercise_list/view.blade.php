            ...
            <div class="exercise-card">
                ...
                <form method="post" action="{{route('admin.new.exercise.update_exercise_list')}}" enctype="multipart/form-data" id="mainExerciseForm">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control searchable-select" name="body_part_id" required readonly>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control searchable-select" name="exercise_style_id" required readonly>
                            <option value="">--Select--</option>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control searchable-select" name="weight" id="exerciseWeight" required readonly>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="video_link" id="youtubeLink" value="{{$exercise_list->video_link}}" required readonly>
        ...
        <div class="col-lg-6 col-md-6 mb-3">
             <div class="exercise-card">
                ...
                <form method="post" action="{{ $hasAlternate ? route('admin.new.exercise.update_alternate_exercise') : route('admin.new.exercise.save_alternate_exercise') }}" enctype="multipart/form-data" id="alternateExerciseForm">
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label">Body Parts <span class="text-danger">*</span></label>
                        <select class="form-control searchable-select-alt" id="alternateBodyPart" name="body_part_id" required readonly>
                            <option value="">--Select--</option>
                            @foreach($body_parts as $body_part)
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label">Exercise Style <span class="text-danger">*</span></label>
                        <select class="form-control searchable-select-alt" id="alternateStyle" name="exercise_style_id" required readonly>
                            <option value="">--Select--</option>
                            @foreach($exercise_styles as $exercise_style)
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label">Weight Required <span class="text-danger">*</span></label>
                        <select class="form-control" name="weight" id="alternateWeight" required readonly>
                    ...
                    <div class="form-group mb-3">
                        <label class="form-label">YouTube Link <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" name="video_link" id="alternateYoutubeLink" value="{{ $hasAlternate ? $alternate->video_link : '' }}" placeholder="Enter YouTube Link" required readonly>
