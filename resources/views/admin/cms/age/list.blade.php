    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Focus</a></li>
            </ol>
        </div>
        <!-- row -->
                            ...
                            <table id="example3" class="display min-w850">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $list['age_range'] }}</td>


                                        <td>
                                            <div class="d-flex">
                                                <a href="#" onclick="edit(`{{ $list['id'] }}`,`{{ $list['age_range'] }}`)" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                <a href="#" onclick="deleteAlert('{{ route('admin.cms.age.delete',$list['id']) }}')" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Create Focus</h5>
                    <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                    </button>
                </div>
                <form method="POST" action="{{ route('admin.cms.age.save') }}" enctype="multipart/form-data">
                    @csrf
                <div class="modal-body"><div class="form-row">
                    <div class="form-group col-md-12">
                        <label>Focus Range</label>
                        <input type="text" class="form-control" name="age_range" required placeholder="Focus ...">
    ...
    <div class="modal fade" id="editModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="{{ route('admin.cms.age.update') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" id="age_id">
                <div class="modal-body"><div class="form-row">
                    <div class="form-group col-md-12">
                        <label>Focus</label>
                        <input type="text" class="form-control" id="age_range" name="age_range" required placeholder="Focus ...">
                        @if ($errors->has('age_range'))
                        <span class="invalid-feedback" role="alert" style="display: block">
                                        <strong>{{ $errors->first('age_range') }}</strong>
                                    </span>
