    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="javascript:void(0)">Online Page Slider Setting</a></li>
            </ol>
        </div>
        <!-- row -->
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Online Page Slider Setting</h4>
                    </div>
                    <div class="card-body">
                        <div class="basic-form">
                            <form method="POST" action="{{route('admin.cms.save_or_update_online_page_slider_setting')}}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" class="form-control" required>{{ old('description', $slider?->description ?? '') }}</textarea>
                                            @error('description')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                <label>Image</label>
                                                <input type="file" name="image" data-default-file="{{$slider?->image ?  URL::to($slider?->image) : '' }}" class="form-control dropify">
                                                @error('image')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <a href="{{route('admin.cms.online_page_setting')}}" type="submit" class="btn btn-default">Back</a>
                            </form>
                        </div>
                    </div>
                </div>
