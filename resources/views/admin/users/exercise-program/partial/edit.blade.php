                                        ...
                                        <div id="week{{ $week['id'] }}-day-{{ $day['id'] + 100 }}"
                                            ...
                                            <form action="{{ route('admin.users.info.save') }}"
                                                ...
                                                <input type="hidden" name="week_id" value="{{ $week['id'] }}"
                                                       id="{{ $week['id'] }}">
                                                <input type="hidden" name="week_name" value="{{ $week['week_name'] }}"
                                                       id="{{ $week['name'] }}">
                                                                    ...
                                                                    <td style="width: 100%;">
                                                                        <div
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                @if($exercise_info['applied_weight'] != null)
                                                                                <span class="badge badge-success" style="font-size: 14px">{{ $exercise_info['applied_weight'] * $exercise_info['reps'] * $exercise_info['sets'] }} <small>(Applied weight)</small></span>
                                                                                @endif
                                                                            </div>
                                                                        </div>
                                                                    </td>
